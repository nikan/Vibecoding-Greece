...
2. **Συμπληρώστε τα στοιχεία** - Χρησιμοποιήστε τον τίτλο του issue ως όνομα έργου και συμπληρώστε URL, περιγραφή, τεχνολογίες, κατηγορία, τύπο υποβολής και κατάσταση έργου
3. **Υποβάλετε** - Το issue θα εξεταστεί και θα προστεθεί αυτόματα στη λίστα
4. **Για ενημερώσεις** - Επιλέξτε `Update existing project` στη φόρμα
